                    ...
                    <div className="hero-background" style={{ background: 'linear-gradient(135deg, #0B1F3A 0%, #0EA5E9 100%)', position: 'relative', border: '1px solid rgba(255,255,255,0.1)' }}>
                        ...
                        <div className="container-luxe hero-content" style={{ zIndex: 10 }}>
                            <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
                                <h1 className="font-tech" style={{ fontSize: '3.8rem', color: '#fff', marginBottom: '1.5rem' }}>Pare-Feu Applicatif de Pointe</h1>
                                <p className="hero-subtext" style={{ fontSize: '1.25rem', color: 'rgba(255,255,255,0.7)', marginBottom: '4rem', lineHeight: '1.7', fontWeight: 400 }}>Bloquez les injections SQL, le Cross-Site Scripting (XSS) et les bots malveillants avant qu'ils n'atteignent votre code. La sentinelle intelligente de votre backend.</p>
                ...
                <section className="section-premium bg-white" style={{ padding: '8rem 2rem', textAlign: 'center' }}>
                    <div className="container-luxe">
                        <div className="section-header" style={{ marginBottom: '5rem', textAlign: 'center' }}>
                            <h2 style={{ fontSize: '3rem', fontWeight: 800, color: '#0B1F3A', marginBottom: '1rem', letterSpacing: '-1px' }}>Inspection Profonde du Trafic (DPI)</h2>
                            <p style={{ fontSize: '1.25rem', color: '#4B5563', maxWidth: '700px', margin: '0 auto', lineHeight: '1.6' }}>Une analyse contextuelle et granulaire de chaque requête HTTP/HTTPS pour une sécurité sans faille.</p>
                        </div>
                        <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
                            <div style={{
                                ...
                                <div style={{ textAlign: 'left' }}>
                                    <h3 style={{ fontSize: '1.8rem', color: '#0B1F3A', marginBottom: '1rem', fontWeight: 800 }}>Protection Anti-Injection (SQLi)</h3>
                            ...
                            <div style={{
                                ...
                                <div style={{ textAlign: 'left' }}>
                                    <h3 style={{ fontSize: '1.8rem', color: '#0B1F3A', marginBottom: '1rem', fontWeight: 800 }}>Défense Cross-Site Scripting (XSS)</h3>
                                    <p style={{ color: '#4B5563', lineHeight: '1.8', margin: 0, fontSize: '1.15rem' }}>
                ...
                <section style={{ padding: '6rem 2rem', background: 'white' }}>
                    <div className="container-luxe">
                        <div style={{
                            ...
                            <div style={{ flex: 1 }}>
                                <h2 style={{ fontSize: '2.5rem', fontWeight: 900, color: '#0B1F3A', marginBottom: '1.5rem' }}>Indispensable pour le E-commerce</h2>
